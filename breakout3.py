...
puntaje = 0
fuente = pygame.font.SysFont(None, 36)  # Fuente para mostrar el puntaje
...
while ejecutando:
    ...
    # Colisión con bloques y actualización del puntaje
    for bloque in bloques[:]:
        if bloque['rect'].colliderect(pelota_rect):
            bloques.remove(bloque)
            pelota_dy *= -1
            puntaje += 5  # Sumar 5 puntos por cada bloque roto
            break
    ...
    pantalla.blit(texto_puntaje, (10, 10))  # Mostrar en la esquina superior izquierda
